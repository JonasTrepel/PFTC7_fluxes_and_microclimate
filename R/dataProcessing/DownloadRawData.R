...
unzip(
  ...
  "data/rawData/LI7500/LI7500_Site 1.zip",
  # Where do you want the files to go to?
  exdir = "data/rawData/LI7500/")

# Remove the zip file once you've unzipped it
file.remove("data/rawData/LI7500/LI7500_Site 1.zip") #let's free some space
...
unzip(
  # Where is the zipped folder?
  "data/rawData/LI7500/LI7500_Site 2.zip",
  # Where do you want the files to go to?
  exdir = "data/rawData/LI7500/")

# Remove the zip file once you've unzipped it
file.remove("data/rawData/LI7500/LI7500_Site 2.zip") #let's free some space
...
unzip(
  # Where is the zipped folder?
  "data/rawData/LI7500/LI7500_Site 3.zip",
  # Where do you want the files to go to?
  exdir = "data/rawData/LI7500/")

# Remove the zip file once you've unzipped it
file.remove("data/rawData/LI7500/LI7500_Site 3.zip") #let's free some space
...
unzip(
  # Where is the zipped folder?
  "data/rawData/LI7500/LI7500_Site 4.zip",
  # Where do you want the files to go to?
  exdir = "data/rawData/LI7500/")

# Remove the zip file once you've unzipped it
file.remove("data/rawData/LI7500/LI7500_Site 4.zip") #let's free some space
...
unzip(
  # Where is the zipped folder?
  "data/rawData/LI7500/LI7500_Site 5.zip",
  # Where do you want the files to go to?
  exdir = "data/rawData/LI7500/")

# Remove the zip file once you've unzipped it
file.remove("data/rawData/LI7500/LI7500_Site 5.zip") #let's free some space
...
unzip(
  # Where is the zipped folder?
  "data/rawData/LI8100/LI8100_Site 1.zip",
  # Where do you want the files to go to?
  exdir = "data/rawData/LI8100/")

# Remove the zip file once you've unzipped it
file.remove("data/rawData/LI8100/LI8100_Site 1.zip") #let's free some space
